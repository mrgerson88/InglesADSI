function generarReporte(fecha_ini,fecha_fin,accion,proveedor){
    let parametros;
    ...
    $('#table-list').DataTable({
        ...
        buttons: [
            {
                extend: 'excelHtml5',
                text: 'Download Excel <i class="ml-1 fas fa-file-excel"></i>',
                titleAttr: 'Excel',
                className: 'btn btn-success btn-flat btn-xs'
            },
            {
                extend: 'pdfHtml5',
                text: 'Download Pdf <i class="ml-1 fas fa-file-pdf"></i>',
                titleAttr: 'PDF',
...
$(function () {
    ...
    $('#id_proveedor').on('change',function () {
        ...
        generarReporte('','','buscar_reporte_proveedor',proveedor)
    })
})